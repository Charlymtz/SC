    ...
    <div className="dark:bg-gradient-to-r from-white via-blue-900 to-blue-300 dark:text-yellow-50">
      <section className="relative flex flex-wrap lg:h-screen lg:items-center">
        ...
        <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24 bg-lavender-200 from-violet-900 via-fuchsia-700 to-violet-900 text-white">
          ...
          <form onSubmit={validateForm} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <span className="absolute inset-y-0 end-0 grid place-content-center px-4">
                  <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#0F4C7F">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <span className="absolute inset-y-0 end-0 grid place-content-center px-4">
                  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#0F4C7F">
